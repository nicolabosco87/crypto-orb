...
const ConnectModal: React.FC<IConnectModalProps> = ({
  isVisible,
  children,
}) => {
  useEffect(() => {
    (window as any).toggleModal("walletModal", isVisible);
  }, [isVisible]);
